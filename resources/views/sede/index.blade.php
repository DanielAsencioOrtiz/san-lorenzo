...
<p class="mb-4">Gestión de sedes</p>

<div class="card shadow mb-4">
    @can('crear sede')
    <div class="card-header py-3">
        <a class="btn btn-success" href="#" data-toggle="modal" data-target="#nuevaSede"><i class="fa fa-plus"></i> Nuevo Registro</a>
    </div>
    @endcan
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="activos">
                @include('sede.partials._tabla', ['sedes' => $sedes, 'tipo' => 'activo', 'tabla' => '1'])
            </div>
            <div class="tab-pane fade" id="eliminados">
                @include('sede.partials._tabla', ['sedes' => $sedesEliminadas, 'tipo' => 'eliminado', 'tabla' => '2'])
            </div>
        </div>
    </div>
</div>
...
<!-- Modal Crear -->
<div class="modal fade" id="nuevaSede" tabindex="-1">
...
<div class="modal fade" id="editarSede-{{ $sede->id }}" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('sede.update', $sede->id) }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header header-modal">
...
<script>
    ...
    $('.restore').on('click', function(e) {
        ...
        swal({
            ...
            text: "¿Deseas restaurar esta sede?",
            type: "warning",
            showCancelButton: true,
